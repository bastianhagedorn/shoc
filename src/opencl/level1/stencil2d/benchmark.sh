...
./Stencil2D --customSize $3,$3 --lsize 4,128 --weight-center 0.25 --weight-cardinal 0.15 --weight-diagonal 0.05 --num-iters 1 --platform $1 --device $2 > measurements/shoc.raw
cd measurements
./cleanse.sh
